<script>
    ...
    let ingredientMap = activateIngredient.ingredients.map((x,i) => (i * 27)+ 189) //height of ingredients on the page used for translate
    let ingredientMapSize = (activateIngredient.ingredients.length * 27) + 189 // height of ingredients used for svgheight
    let instructionMap = activateIngredient.preparation.map((x,i) => (i * 40)+ 189)
    let instructionMapSize = (activateIngredient.preparation.length * 40) + 189
    ...
    onMount(() => {
        ...
        gsvgHeight > isvgHeight
            ? (svgHeight = gsvgHeight)
            : (svgHeight = isvgHeight);
        ...
        return [
            ...
            ingredientBook.subscribe((value) => {
                let isTrue = (element) => element.active == true || element.active == "true"
                let activeIng = value.findIndex(isTrue)
                activateIngredient = value[activeIng]
                setPageName([activateIngredient.name,"recipe"],activateIngredient.subHeading, activateIngredient.pic);
                console.log("VAL: ", value);
                console.log("activeIng", activeIng);
            }),
        ];
    });
        ...
        >
            <g id="recipe">
                ...
                <text
                    ...
                    ><tspan x="0" y="0">{activateIngredient.ingredientName}</tspan></text
                >
                <text
                    id="_Body_2"
                    data-name="✏️ Body 2"
                    ...
                    ><tspan x="0" y="0">{activateIngredient.subHeading}</tspan></text
                >
            </g>
        </g>
        <g
...
<Router basepath="/recipe" url="/recipe">
    <div
        id="container"
        style="height:{window.innerHeight - recipeContainerTop() - 50}px"
    >
                ...
                <g id="recipe-container" width={windowWidth} height={svgHeight}>
                    ...
                    >
                        ...
                        <g id="instruction-list" transform="translate(0 0)">
                            {#each activateIngredient.preparation as prep, i}
                                <foreignObject
                                    transform="translate(26 {instructionMap[
                                        i
                                    ]})"
                                    width={isLarge ? 300 : windowWidth - 30}
                                    height="40"
                                    requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility"
                                >
                                    <div
                                    ...
                                    >
                                        <span
                                            style="height:24px; width:24px; margin:0 10px 0 0;"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                            ...
                                            >
                                                <g
                                                    id="icon_toggle_radio_button_checked_24px"
                                                    data-name="icon/toggle/radio_button_checked_24px"
                                                >
                                                    <rect
                                                        id="Boundary-3"
                                                        data-name="Boundary"
                                        ...
                                        <span
                                            style="height: 24px;width: 270px;margin: 0px;display: flex;align-content: center;align-items: flex-end;"
                                        >
                                            <p
                                                style="height: 24px;width: 270px;margin: 0px;font: var(--font-ingredient-font);text-align: left;display: flex;align-items: center;"
                                            >
                                                {prep}
                                            </p>
                                        </span>
                    ...
                    >
                        ...
                        {#each activateIngredient.ingredients as ing, i}
                            <foreignObject
                                transform="translate(26 {ingredientMap[i]})"
                                width={isLarge ? 400 : windowWidth - 30}
                                height="40"
                                requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility"
                            >
                                <div
    ...
    <footer style="height:50px">
        ...
        >
            <g
                id="extended-navbar"
                transform="translate({windowWidth / 2 - 120} )"
            >
                <rect
                        ...
                        >
                            ...
                            >
                                ...
                                <text
                                    ...
                                    font-family="Roboto-Regular, Roboto"
                                    letter-spacing="0.009em"
                                    ><tspan x="0" y="0">Ingredients</tspan
                                    ></text
                                >
                                <g
                        ...
                        >
                            ...
                            >
                                ...
                                <text
                                    ...
                                    font-family="Roboto-Regular, Roboto"
                                    letter-spacing="0.009em"
                                    ><tspan x="0" y="0">Instructions</tspan
                                    ></text
                                >
                                <g
                                    transform="matrix(1, 0, 0, 1, -4, 0)"
