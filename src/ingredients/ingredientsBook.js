...
export const macaroniWithWhiteSauce = {
    pic: macaroniImage,
...
export const fishFilet = {
    pic: fishFiletImage,
    ingredientName: "Fish Filet",
...
export const panGrilledChicken = {
...
export const tropicalBellPepperSalad = {
    pic: tropicalBellPepperSaladImage,
    ingredientName: "Tropical Bell Pepper",
