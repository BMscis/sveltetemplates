...
const ingredients = {
    butterChickenIngredient : {
        ...
        preparation: [
            ...
            "Stir in the onions until translucent.",
            ...
            "Add in the cooking cream.", 
            "Cover the pan and allow to simmer on low heat for 20 minutes.",
            "Add in the salt and continue to simmer the chicken.",
    ...
    macaroniWithWhiteSauce : {
        ...
        preparation: [
            ...
            "Stir in the onions," ,
            "Allow them to cook on low heat until translucent",
            "Followed by the crushed garlic for 30 seconds.",
            "Gradually mix in the flour for about a minute.",
            "Gently stir in the water to keep the flour from clumping.",
            "Add in the stock to smoothen the consistency on a low flame.",
            "Combine the macaroni and sauce for two minutes.",
            "Add the milk, cover the pan and keep," ,
            "simmering on low flame for 5 - 8 minutes. ",
            "Sprinkle the black pepper over the macaroni.",
    ...
    fishFilet : {
        ...
        preparation: [
            ...
            "Stir in the onions.",
            "Cook on low heat until translucent. ",
            "Mix in the crushed garlic for 30 seconds.",
            "Add in the dhana jeera and turmeric.",
            "Allow to toast for  1 to 2 minutes.",
            "Increase the heat to medium heat.",
            "Stir in the tomatoes to combine with the onion-spice mix. ",
            "Cover the pan to steam the tomatoes until soft and pulpy. ",
            "Mix in the tomato paste and let cook for a minute.",
            "Mix in the fish fillet cubes.",
            "Gently using your cooking spoon to coat them in the paste. ",
    ...
    panGrilledChicken : {
        ...
        preparation: [
            ...
            "Add the chicken pieces to fit in the pan. ",
            "Allow the first side to grill for 5 minutes.",
            "Turn to the other side",
            "After grilling both sides, turn once more and cover the pan. ",
            "Lower the flame and turn the sides every 5 minutes.",
            "Baste the chicken occasionally with warm water.",
    ...
    tropicalBellPepperSalad : {
        ...
        preparation: [
            "Prepare the fruit and vegetables as recommended.",
