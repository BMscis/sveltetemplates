...
import { afterUpdate } from "svelte";
    ...
    for(let i = 0; i < butterChicken.ingredients.length; i++){
...
<Router basepath="/page-ingredients" url="page-ingredients">
    ...
    >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="319" height={ingredientCount} viewBox="0 0 319 {ingredientCount}">
            <defs>
              <clipPath id="clip-path">
                <rect id="photo" width="315" height="212" rx="8" transform="translate(0 27)" fill="#792121"/>
              </clipPath>
            </defs>
            <g id="content" transform="translate(-30 -62)">
              <g id="recipe-information">
                <g id="difficulty" transform="translate(35)">
                  <text id="Easy" transform="translate(247 432)" fill="#748a9d" font-size="16" font-family="SegoeUI, Segoe UI" letter-spacing="-0.01em"><tspan x="0" y="0">{butterChicken.estimation[0]}</tspan></text>
                  <text id="Prep_20m" data-name="Prep 20m" transform="translate(247 468)" fill="#748a9d" font-size="16" font-family="SegoeUI, Segoe UI" letter-spacing="-0.01em"><tspan x="0" y="0">{butterChicken.estimation[1]}</tspan></text>
                  <text id="Cook_5m" data-name="Cook 5m" transform="translate(247 504)" fill="#748a9d" font-size="16" font-family="SegoeUI, Segoe UI" letter-spacing="-0.01em"><tspan x="0" y="0">{butterChicken.estimation[2]}</tspan></text>
                ...
                {#each butterChicken.ingredients as ingredient ,i}
              ...
              <g id="photo-2" data-name="photo" transform="translate(0 100)" clip-path="url(#clip-path)">
                <image href={butterChickenImage} x="0" y="0" width="315" height="212"/>
              </g>
              <text id="Mixed_Berry_Melody" data-name="Mixed Berry Melody" transform="translate(188 84)" fill="#748a9d" font-size="20" font-family="SegoeUI, Segoe UI" letter-spacing="-0.01em"><tspan x="-86.86" y="0">{butterChicken.ingredientName}</tspan></text>
            </g>
          </svg>
        </div>
        <IngredientComponent
        slot="slot2"
        ingredients={butterChicken.ingredients}
        preparation={butterChicken.preparation}
    />
    </FormViewer>
</Router>
</div>
